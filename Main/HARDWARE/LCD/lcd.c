...
void LCD_GPIOInit(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_2| GPIO_Pin_8| GPIO_Pin_11| GPIO_Pin_12 | GPIO_Pin_13; 
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;   //推挽输出
	GPIO_Init(GPIOA, &GPIO_InitStructure); //控制引脚
	GPIO_SetBits(GPIOA,GPIO_Pin_2|GPIO_Pin_8|GPIO_Pin_11|GPIO_Pin_12|GPIO_Pin_13);
