...
#define LCD_RS   12       //寄存器/数据选择引脚  PA12 
#define LCD_RST  13       //复位引脚            PC13(这里不用软件复位)
#define LCD_WR   11       //写引脚              PA11
#define LCD_RD   13       //读引脚              PA13


//QDtech全系列模块采用了三极管控制背光亮灭，用户也可以接PWM调节背光亮度
#define	LCD_LED PAout(LED) //LCD背光    		 PC10
...
#define LCD_RD_SET  GPIOA->BSRR=1<<LCD_RD    //读		  
...
#define LCD_RD_CLR  GPIOA->BRR=1<<LCD_RD     //读	  		  
